...
#- PiCamera captures a frame. 
#- People are detected using Machine Learning moldel & TensorFlow Lite interpreter.
#- OpenCV adds bounding boxes, center coordinates of the person, deviation of the person from center of the frame etc.
#- FLASK streams the robot's view over LAN (accessed via browser).
#- Google Coral USB Accelerator makes it all fast (the inferencing process).
