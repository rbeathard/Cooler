...
function init(){
	document.getElementById("hw_1").innerHTML="<a style='color:grey;text-decoration:none' href='https://en.wikipedia.org/wiki/Sarah_Connor_%28Terminator%29' target='_blank'>Have you seen this woman?</a>";
	document.getElementById("hw_2").innerHTML="<a style='color:grey;text-decoration:none' href='https://github.com/jiteshsaini' target='_blank'>Cyberdyne</a>";
	document.getElementById("hw_3").innerHTML="<a style='color:grey;text-decoration:none' href='https://youtu.be/QIcomuI1j7I' target='https://youtu.be/QIcomuI1j7I'>Demo Video</a>";
