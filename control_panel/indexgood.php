<!DOCTYPE html>
<html lang="en"> 
<body style="background-color:#4a4646">
<head> 
...
echo"<div align='center' id='box_outer'>";//------------------------
	echo"<b align='center' style='font-size:40px;color:##d4040b'>SKYNET</b>";
	echo"<a href='readme/' target='_blank'><img style='float:right' src='/earthrover/control_panel/css/images/Skynet_logo.jpg' height='65px'></a>";
	echo"<div align='center' class='box_inner'>";//------------------------
		...
		echo"<div class='box_controls' style='width:20%'>";
			echo"<zz>";
				echo"<label class='floatLabel' style='width: 120px;'>Robotic Controls</label><br>";
	...
	echo"<div align='center' class='box_inner'>";//------------------------
		...
		echo"<div class='box_controls' style='width:14%'>";
			echo"<zz>";
				...
				echo"<br>";
				echo"<txt>Headlight</txt>";
				echo"<txt>Emergency</txt>";
			echo"</zz>";
		echo"</div>";
