...
def append_text_img1(cv2_im, objs, labels, arr_dur, counter, selected_obj):
    ...
    cv2_im = cv2.putText(cv2_im, text_dur, (int(width/4)-30, 16),font, 0.4, (255, 255, 255), 2)
    ...
    for obj in objs:
        ...
        if (percent>=60):
            box_color, text_color, thickness=(0,255,0), (0,255,0),4
        elif (percent<60 and percent>40):
            box_color, text_color, thickness=(0,0,255), (0,0,255),3
        else:
            box_color, text_color, thickness=(255,0,0), (255,0,0),2
